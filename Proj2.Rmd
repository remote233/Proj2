...
per_combined %>%
  kbl(caption="Percent of pixels for the different classes",
       format= "latex",
                  align="r") %>%
...
per_combined %>%
  kbl(caption="Accuracy of trivial classifier",
       format= "latex",
                  align="r") %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "HOLD_position")
...
```{r, fig.width=8, fig.height=3, fig.cap="\\label{fig:figs}Feature importance by random forest"}
par(mfrow=c(1,2))
...
tab %>%
  kbl(caption="AUC of different features",
       format= "latex",
                  align="r") %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "HOLD_position")
...
result_table1 %>%
  kbl(caption="Accuracy of data from split method1",
       format= "latex",
                  align="r") %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "HOLD_position", full_width = F, position = "float_left")
...
result_table2 %>%
  kbl(caption="Accuracy of data from split method2",
       format= "latex",
                  align="r") %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
...
test_accuracy %>%
  kbl(caption="Test accuracy of models in different datasets",
       format= "latex",
                  align="r") %>%
  kable_classic(full_width = F, html_font = "helvetica") %>%
  kable_styling(latex_options = "HOLD_position", full_width = F, position = "left")
